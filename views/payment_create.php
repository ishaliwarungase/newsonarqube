								...
								<input type="hidden" name="user_id" value="" id="non_mem_id">
									...
									<div id="check_non_member" style="display: none">
										<div class="row">
											...
											<div class="col-md-6 form-group form-animate-text"><br>
												...
												<input type="text" class="form-text" id="non_mem_name" name="non_mem_name" required maxlength="100" minlength="3">
												<span class="bar"></span>
											...
											<div class="col-md-6 form-group form-animate-text"><br>
												...
												<span class="bar"></span><small style="color: #3e3c3c">10 digits only</small>
									...
									<div class="row">
										...
										<div class="col-md-6 form-group form-animate-text"><br>
											...
											<input type="text" class="form-text" id="validate_reciept" name="validate_reciept" required maxlength="20" minlength="3">
											<span class="bar"></span>

										</div>

										<div class="col-md-6 form-group form-animate-text"><br>
											<h4 class="text-left"><i class="fa fa-money"></i> Amount [Rs.]<span style="color: #F44336">*</span></h4>
